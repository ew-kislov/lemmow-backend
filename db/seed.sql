...
INSERT INTO
    lm_user(first_name, second_name, email, password, company_id, registration_date, role_id)
VALUES
    ('Rafik', 'Avetisyan', 'rakek@gmail.com', 'rafik', 1, '2020-01-01', 2),
    ('Ivan', 'Ivanov', 'ivan@gmail.com', 'ivan', 1, '2020-01-01', 3),
    ('Michael', 'Jackson', 'nigger@gmail.com', 'nigger', 1, '2020-01-01', 4);
